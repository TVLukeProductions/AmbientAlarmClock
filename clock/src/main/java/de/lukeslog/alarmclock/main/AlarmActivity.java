...
import de.lukeslog.alarmclock.main.OldClockService.LocalBinder;
...
public class AlarmActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		try
		{
			getApplicationContext().startService(new Intent(this, OldClockService.class));
	        Intent intent = new Intent(this, OldClockService.class);
